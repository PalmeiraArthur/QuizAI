...
function QuizIcon({ id, title, cover }) {
  ...
  return (
    <Link to={`/quiz/${id}`} className="flex flex-col items-center">
      <div
        className="relative group w-[93px] h-[93px] rounded-[5px] shadow-md flex flex-col items-center justify-center overflow-hidden cursor-pointer md:w-[132px] md:h-[160px]"
